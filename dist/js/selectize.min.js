...
}}(),c.onKeyDown=function(){var a=c.onKeyDown;return function(b){a.apply(c,arguments),27===b.keyCode&&this.$empty_results_container.hide()}}(),c.onBlur=function(){var a=c.onBlur;return function(){a.apply(c,arguments),this.$empty_results_container.hide()}}(),c.setup=function(){var d=c.setup;return function(){d.apply(c,arguments),c.$empty_results_container=a(b.html(a.extend({classNames:c.$input.attr("class")},b))),c.$empty_results_container.insertBefore(c.$dropdown),c.$empty_results_container.hide()}}()}),L.define("restore_on_backspace",function(a){var b=this;a.text=a.text||function(a){return a[this.settings.labelField]},this.onKeyDown=function(){var c=b.onKeyDown;return function(b){var d,e;return b.keyCode===p&&""===this.$control_input.val()&&!this.$activeItems.length&&(d=this.caretPos-1,d>=0&&d<this.items.length)?(e=this.options[this.items[d]],this.deleteSelection(b)&&(this.setTextboxValue(a.text.apply(this,[e])),this.refreshOptions(!0)),void b.preventDefault()):c.apply(this,arguments)}}()}),L});