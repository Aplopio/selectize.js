# The build we use right now is generated by following command
```
grunt --plugins=dropdown_header,clear_selection,restore_on_backspace,enhanced_control_input,no_results,remove_button
```

## Todo:
[ ] - Update this repo with the css styles we use in our app.
